...
@section('content')
    ...
    <!-- Main content -->
    <div class="content row align-items-center my-4">
        <div class="col">
            <h2 class="h3 mb-0 page-title">{{ __('Lista de permisos') }}</h2>
        </div>
        <div class="col-auto">

            <a class="btn btn-primary" href="{{ route('admin.permissions.create') }}" data-toggle="modal"
                data-target="#ModalCreate"><i class="fas fa-plus-square"></i> Agregar permiso</a>
...
@section('js')
    ...
    <script>
        ...
        $(".botonEditar").click(function(e) {
            ...
            var nameEditar = $(this).data("name");
            console.log(nameEditar);


            $("#name_editar").val(nameEditar);
